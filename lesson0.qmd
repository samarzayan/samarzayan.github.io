...
![*Figure 1: "How to fast.ai"*](how_to_fastai.png)
...
![*Figure 2: fast.ai textbook*](fastai_textbook_lesson_0.png)

The textbook is available for purchase on Amazon and is also available for free on Github as a [fastbook](https://github.com/fastai/fastbook) repo.
...
![*Figure 3: Finish It*](finish_it.gif)
...
One of the former students and a fantastic alumni, [Christine McLeavy](https://christinemcleavey.com/) who now is at [OpenAI](https://openai.com/), one of the top research organizations took this advice to heart given by Jeremy back then and made a fantastic AI system that could create new music using Deep Learning. Her work was featured and played on the BBC orchestra and helped her get the exclusive job at [OpenAI](https://openai.com/)

![*Figure 4: McCleavy sharing her insights in a postcast with Sanyam, another former student*](do_a_project.png)

:::{.callout-note}
The podcast can listened [here](https://www.youtube.com/watch?v=xwXIaDrQvwE).
:::
...
![*Figure 5: On tenacity*](tenacity.png)
...
![*Figure 6: Radek Insights*](radek_insights.png)
...
3. There are a few topics that are expected to know as a CS student but are never taught. Some MIT students have created a lovely course that will help us learn these things and they called it [The Missing Semester Of Your CS Education](https://missing.csail.mit.edu/). This will help build the software environment foundations.
  ![*Figure 9: 4 legged table*](insight_3.png){#fig-legged} 
...
![*Figure 10: Radek on sharing the work*](share.png)
...
![*Figure 11: 4 steps of doing a lesson*](four_steps.png)
...
![*Figure 12: How Not To Do fast.ai*](how_not.png)
...
![*Figure 13: Right combination of theory & practice*](rinse.png)
...
![*Figure 14: Read & write code*](read_write_code.png)
...
![*Figure 15: Jeremy's Twitter feed as an example*](jeremy_twitter.png)
...
![*Figure 16: Hidden gem of ML*](gem.png)
...
![*Figure 17: Radek's insights*](ml_hard.png)
...
![*Figure 18: On baseline for projects*](baseline.png)
...
![*Figure 19: On Kaggle Competitions*](kaggle.png)
...
![*Figure 20: On finding a job*](job.png)
