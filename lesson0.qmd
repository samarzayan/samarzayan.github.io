...
:::{.callout-note}
The coding environment is different in the 2022 version of the course. Hence, this setup may not be relevant.
:::
...
There is an actual textbook written by Jeremy and Sylvain which can be followed along with the course.
